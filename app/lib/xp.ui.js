if (!OS_IOS) {
    ...
    NavigationWindow.prototype.openWindow = function(window, options) {
        ...
        if (OS_ANDROID && options.animated !== false) {
            // options.activityEnterAnimation = Ti.Android.R.anim.slide_out_right;
            // options.activityExitAnimation = Ti.Android.R.anim.slide_out_right;
            options.activityEnterAnimation = Ti.Android.R.anim.fade_in;
            options.activityExitAnimation = Ti.Android.R.anim.fade_out;
